...
class NoticiasProductos extends React.Component {
    ...
    return (
      ...
      <Container style={styles.container}>
        <Header style={styles.head}>
          <Left>
            <Button transparent>
              <Icon name='arrow-back' onPress={() => this.props.navigation.navigate('Noticias')}
                style={{ color: 'white' }}/>
            </Button>
          </Left>
          <Body>
        ...
        <Content showsVerticalScrollIndicator={false}>
          <Image style={styles.destaque}          
            source={require('../assets/images/noticias-destaque.png')} 
          />
          

          <Text style={{ fontSize: 20, paddingLeft: 20, paddingTop: 20 }}>Ejemplos de noticias</Text>
...
export default NoticiasProductos;