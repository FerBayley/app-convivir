...
class VidaSanaArticulo extends React.Component {
    ...
    return (
      ...
      <Container style={styles.container}>
        <Header style={styles.head}>
          ...
          <Body>
            <Title style={styles.textoBotones}>Señores de nuestras vidas</Title>
          </Body>
          <Right>
            <Button transparent>
        ...
        <Content showsVerticalScrollIndicator={false}>
          <Image style={styles.destaque}          
            source={require('../assets/images/articulo-vidasana.png')} 
          />
...
export default VidaSanaArticulo;