...
class HomeopatiaArticulo extends React.Component {
      ...
      <Container style={styles.container}>
        ...
        <Content showsVerticalScrollIndicator={false}>
          <Image style={styles.destaque}          
            source={require('../assets/images/homeopatiaArticulo.png')} 
          />
          

          <Text style={{ fontSize: 20, paddingLeft: 20, paddingTop: 20 }}>Homeopatía ¿Por qué no?</Text>
...
export default HomeopatiaArticulo;