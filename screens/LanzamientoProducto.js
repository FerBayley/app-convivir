...
class LanzamientoProducto extends React.Component {
    ...
    return (
      ...
      <Container style={styles.container}>
        <Header style={styles.head}>
          <Left>
            <Button transparent>
              <Icon name='arrow-back' onPress={() => this.props.navigation.navigate('Lanzamientos')}
                style={{ color: 'white' }}/>
            </Button>
          </Left>
          <Body>
            <Title style={styles.textoBotones}>Lanzamientos Producto</Title>
          </Body>
          <Right>
            <Button transparent>
        ...
        <Content showsVerticalScrollIndicator={false}>
          <Image style={styles.destaque}          
            source={require('../assets/images/btik-producto.png')} 
          />
          

          <Text style={{ fontSize: 20, paddingLeft: 20, paddingTop: 20 }}>Ejemplos de lanzamientos de productos</Text>
...
export default LanzamientoProducto;