...
class AlimentacionArticulo extends React.Component {
      ...
      <Container style={styles.container}>
        ...
        <Content showsVerticalScrollIndicator={false}>
          <Image style={styles.destaque}          
            source={require('../assets/images/articulo-matcha.png')} 
          />
          

          <Text style={{ fontSize: 20, paddingLeft: 20, paddingTop: 20 }}>Smoothie de Matcha</Text>
...
export default AlimentacionArticulo;